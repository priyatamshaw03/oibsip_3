    ...
    public static void main(String args[]) {
        ...
        while(i<3)
        {
            ...
            else
            {
                ...
                while(true)
                {
                    System.out.println("\n...WELCOME to the SAHARA BANK...");
                    System.out.println("``````````````````````````````````");
                    System.out.println("BANKING CREDENTIALS for this Session");
                    System.out.println("------------------------------------");
                    ...
                    {               
                        ...
                        System.out.println("````````````````````````````````");
                        System.out.println("Press '0' for MINI STATEMENT");
                        ...
                        switch(input)
                        {
                            case 0:
                                ...
                                {
                                    System.out.println("Total Transactions found : "+counter);
                                }
                                break;
                            case 1:
                            ...
                            case 2:
                                ...
                                System.out.println("Press '1' to Confirm or Press '0' to Cancel ");
                                check=sc.nextInt();
                                if(check==1)
                                {
